...
class BluetoothDeviceInfo {
  ...
  static BluetoothDeviceInfo decode(Object result) {
  ...
  bool operator ==(Object other) {
    if (other is! BluetoothDeviceInfo || other.runtimeType != runtimeType) {
      return false;
    }
...
class FlutterBthidApi {
  /// Constructor for [FlutterBthidApi]. The [binaryMessenger] named argument is
  /// available for dependency injection. If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  FlutterBthidApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<void> init() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_bthid.FlutterBthidApi.init$pigeonVar_messageChannelSuffix';
